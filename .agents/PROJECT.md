...
The [public skill README template](../skills/.domfiles-agent-documentation/assets/readme-skill.txt) fixes shared publisher and license details because all public skills share the same source repository and attribution.
