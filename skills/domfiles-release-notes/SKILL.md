...
Follow the `simple-github-cli` workflow when a release task uses GitHub CLI. Do not publish a release, create a tag, or bump a version unless the user explicitly requests that mutation.
