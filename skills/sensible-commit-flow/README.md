[![](https://skills.sh/b/porada/domfiles)](https://www.skills.sh/porada/domfiles/sensible-commit-flow)
...
```sh
npx skills add porada/domfiles --skill sensible-commit-flow
```

```sh
gh skill install porada/domfiles sensible-commit-flow
```
