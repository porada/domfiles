...
- Treat the global “Writing” policy as the canonical semantic owner of the required standalone mirrors in the `human-facing-writing` skill’s `references/typography.md`.
