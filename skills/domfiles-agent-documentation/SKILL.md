...
- Compose every command-only description and every public description through `human-facing-writing` as a polished, standalone writing unit. Encode those descriptions as YAML `|-` literal block scalars, and separate coherent parts with blank lines. Keep model-invocable internal and global descriptions as plain scalars.
...
- For public skills in either invocation mode, also apply the [public-specific description framing contract](references/public-skill-portability.md#add-public-description-framing).
