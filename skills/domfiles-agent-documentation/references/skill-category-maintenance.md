...
Use the applicable project’s skill classification to resolve each skill’s category, canonical source, logical name, metadata, supported installation, and whether the category permits bundled scripts before applying these rules.
...
Before moving or rewriting content in a promotion to the public category, complete the [public promotion profile](public-skill-portability.md#build-the-public-promotion-profile).
